...
export class ProjectService {
  ...
  addUsersToProject(users: number[] | string[], projectId: number): Observable<{ message: string } | HttpErrorResponse> {
  ...
  addAdminsToProject(users: number[] | string[], projectId: number): Observable<{ message: string } | HttpErrorResponse> {
    return this.http.post<{ message: string }>(
